...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary grid gap-y-6 pb-8">
      ...
      <div id='footer-img-container' className="px-10 flex justify-center w-full" >
        <div className='flex justify-start gap-1 flex-row w-10/12'>
          <img src={BOUTIQUE0} className="block w-auto h-24 boutique-img-logo -rotate-12 opacity-0 border-black" />
          <img src={BOUTIQUE1} className="block w-auto h-24 boutique-img-logo -rotate-12 opacity-0" />
          <img src={BOUTIQUE2} className="block w-auto h-24 boutique-img-logo -rotate-12 opacity-0" />
          <img src={BOUTIQUE3} className="block w-auto h-24 boutique-img-logo -rotate-12 opacity-0" />
          <img src={BOUTIQUE4} className="block w-auto h-24 boutique-img-logo -rotate-12 opacity-0" />
          <img src={BOUTIQUE5} className="block w-auto h-24 boutique-img-logo -rotate-12 opacity-0" />
          <img src={BOUTIQUE6} className="block w-auto h-24 boutique-img-logo -rotate-12 opacity-0" />
          <img src={BOUTIQUE7} className="block w-auto h-24 boutique-img-logo -rotate-12 opacity-0" />
          <div className='w-10 h-10'></div>
          <img src={BOUTIQUE8} className="block w-auto h-24 boutique-img-logo -rotate-12 opacity-0" />
          <img src={BOUTIQUE9} className="block w-auto h-24 boutique-img-logo -rotate-12 opacity-0" />
          <img src={BOUTIQUE10} className="block w-auto h-24 boutique-img-logo -rotate-12 opacity-0" />
          <img src={BOUTIQUE11} className="block w-auto h-24 boutique-img-logo -rotate-12 opacity-0" />
          <img src={BOUTIQUE12} className="block w-auto h-24 boutique-img-logo -rotate-12 opacity-0" />
        </div>
