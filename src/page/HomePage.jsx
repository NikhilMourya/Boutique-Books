        ...
        <>
            <section className="w-full relative bg-white">
                <main className="py-32 my-20">
                    <div><h1 className="font-primary lg:text-4xl md:text-3xl text-xl">Seamless Accounting with <br />
                    ...
                    <div className="my-4 p-3 flex gap-5 justify-center items-center">
                        <button className="md:px-7 px-4 p-2 border-black border text-black rounded-full md:text-md text-sm">Learn More</button>
                        <button className="md:px-7 px-4 p-2 button-primary-bg text-white rounded-full">
                            <div className="flex gap-3 flex-row">
                                <div className="inline-flex gap-3">
                                    <span className="md:text-md text-sm">Book a Call</span>
                ...
                <div className="relative my-14 py-14 keyboard-container">
                    <div className="relative z-10">
                        <div className="relative">
                            <h1 className="font-primary md:text-4xl sm:text-2xl">Streamlined Accounting</h1>
                            <h1 className="font-primary md:text-4xl sm:text-2xl mt-4">with the Press of a Key.</h1>
                            ...
                            <img id="keyboard-hand" src={Finger} className="absolute right-56 md:right-44 -bottom-36 md:h-40 lg:h-56 w-auto" />
                        </div>
                    </div>
                ...
                <section className="py-20 md:p-10 sm:p-4 m-8 md:m-16 lg:m-28">
