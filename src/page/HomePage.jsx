          ...
          <div className=" mx-auto w-[80%]" id="lady-laptop">
            <div className="mx-auto">
              <div className="center relative">
                <img
                  className="hidden sm:block w-full h-screen object-cover md:h-full"
                  src={ladyWithLaptop}
                />
                ...
                >
                  <div className="p-5 md:p-10 w-full md:w-4/5 mx-auto">
                    <div className="mx-auto text-white">
                      ...
                      <section className='grid grid-cols-1 gap-5 justify-center items-center'>
                        ...
                        <div className='hidden md:grid md:grid-cols-3 gap-5 justify-center items-center' >
                          {
                            firmOffers.map((offer, index) => {
                              return (
